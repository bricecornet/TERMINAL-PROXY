...
<head>
    ...
    <style>
        ...
        /* RESET & BOX SIZING pour un responsive propre */
        * {
        ...
        h1 { border-bottom: 2px dashed var(--text-color); padding-bottom: 10px; margin-bottom: 30px; font-size: 1.5em;}
        
        a {
            color: var(--link-color); text-decoration: none;
            border-bottom: 1px dotted var(--link-color); transition: all 0.2s;
            word-break: break-all; /* Les URL longues ne cassent pas la page */
        }
        a:hover, a:focus {
        ...
        /* ASCII ART : Adaptation mobile */
        pre {
            white-space: pre-wrap; /* Évite le scroll horizontal */
            font-size: 10px; /* Réduit la police sur PC */
            overflow-x: hidden;
        }
        ...
        .prompt-label { 
            ...
            font-weight: bold; 
            user-select: none;
            white-space: nowrap; /* "C:\WEB\>" ne doit pas être coupé */
        }
        ...
        .terminal-input {
            ...
            outline: none; 
            padding: 10px;
            min-width: 0; /* Important pour que flexbox réduise l'input */
        }
        ...
        @media screen and (max-width: 600px) {
            ...
            /* Ajustement ASCII Art sur mobile */
            pre { font-size: 7px; line-height: 8px; }
            ...
            .terminal-input {
                width: 100%;
                border-bottom: 1px dashed #333; /* Séparation visuelle */
            }

            .terminal-submit {
                width: 100%;
                margin-top: 5px;
                padding: 15px; /* Zone de touche plus grande pour le doigt */
            }
        }
    </style>
</head>
